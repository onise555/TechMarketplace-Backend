...
namespace TechMarketplace.API.Controllers.AdminControllers
{
    ...
    public class AdminProdctsController : ControllerBase
    {
        ...
        public AdminProdctsController(DataContext data, JwtServices jwt, EmailSender emailSender)
        {
            _data = data;
            _Jwt = jwt;
        ...
        public ActionResult AddProduct([FromForm] CreateProductRequest request)
        {
